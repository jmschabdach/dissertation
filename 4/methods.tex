...
%ICA treats the different behaviors present across individual voxels throughout the time course of the image; image as a series of signal sources combined to create the observed signal. 
...
\begin{figure}
\centering
\subfigure[PCA]{\includegraphics[width=.49\textwidth]{4/pca.png}}
\subfigure[t-SNE]{\includegraphics[width=.49\textwidth]{4/tsne.png}}\\
\subfigure[UMAP]{\includegraphics[width=.5\textwidth]{4/umap.png}}\\
