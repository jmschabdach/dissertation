...
\usepackage{subfigure} % fit multiple graphics in one figure
...
\date{June 27, 2019}%             This date is the date of the thesis defense. Default is \today
...
\include{3/clinical_background}

\include{4/motion-correction}
\include{4/methods}
\include{5/data}
