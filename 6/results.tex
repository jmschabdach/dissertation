...
The average correlations between the best matching components and the DMN ROI were 8122.41 for the traditionally registered sequences and 8039.52 for the DAG-registered sequences. Neither the Kolmogorov-Smirnov test nor the t-test estimated a statistical significance between the correlation distributions between the best matching component and the DMN ROI for the registered sequences (KS p-value = 0.999; t-test p-value 0.807).
